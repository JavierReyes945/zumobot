...
% Graphics package to deal with images
...
\lstset{language        = VHDL,
        ...
        morekeywords    = {integer, time, ns, work},
        stringstyle     = \color{mygray},
        morestring      = [b]",
        identifierstyle = \color{black},
        numberstyle     = \color{mygray},
        emph            = [1]{IEEE, STD_LOGIC_1164, numeric_std, std_logic, std_logic_vector, to_unsigned, rising_edge},
