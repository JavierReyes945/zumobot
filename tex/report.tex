...
\usepackage{amsmath}	% Special functions
\usepackage{comment}	% Comment long
\usepackage{amssymb}	% Lagrange symbol
...
\maketitle
\pagenumbering{gobble}	% Title page is not numbered
\newpage
\pagenumbering{arabic}	% Page after title is numbered as first

\tableofcontents
\newpage

\section*{Introduction}	% Introduction section is not numbered inside content
